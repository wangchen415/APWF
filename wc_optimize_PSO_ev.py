...
from wc_evaluate_ev import evaluate
...
if __name__ == "__main__":
    ...
    # indicator_=['kge','r_square','kge','r_square','kge','r_square','kge','r_square']
    # module_=['flow-SUB-Mon','TC-SUB-Mon','flow-SUB-Mon','TC-SUB-Mon','flow-SUB-Mon','TC-SUB-Mon','flow-SUB-Mon','TC-SUB-Mon']
