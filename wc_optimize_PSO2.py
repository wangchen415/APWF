...
class Prepare_Weight:
    ...
    def param_rank(self):
        ...
        if self.modle.split('-')[0]=='TC' or self.modle.split('-')[0]=='flow&ET':
            param_rank=param['ET']
        else:
...
if __name__ == "__main__":
    ...
    indicator_=['kge','kge','kge','kge','kge','kge','kge','kge']
    module_=['flow&ET-SUB-Mon','flow&ET-SUB-Mon','flow&ET-SUB-Mon','flow&ET-SUB-Mon','flow&ET-SUB-Mon','flow&ET-SUB-Mon','flow&ET-SUB-Mon','flow&ET-SUB-Mon']
    iter_a = []
    para = []
    iter_b = []
    v_low = -1000
